...
function refreshLibraryInfoInDrawer(user) {
    ...
    html += `<a is="emby-linkbutton" class="navMenuOption lnkMediaFolder" href="#/home"><span class="material-icons navMenuOptionIcon home" aria-hidden="true"></span><span class="navMenuOptionText">${globalize.translate(
        "Home"
    )}</span></a>`;
...
function setDefaultTitle() {
    ...
    if (pageTitleElement) {
        ...
        // Show fixed brand text next to the logo background
